...
public class lemmaToSat {
    public static void main(String[] args) {
        ...
        SATEncoder encoder = new SATEncoder("Shurs_lemma", "ShursLemma/Shurs_lemma_enc.cnf");
        ...
        // uso un iteratore delle terne di biglie in modo da controllare quando i valori
        // delle biglie

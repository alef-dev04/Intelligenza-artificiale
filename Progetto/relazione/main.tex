...
MAPE\footnote{Il \textit{Mean Absolute Percentage Error (Errore Assoluto Medio Percentuale)} misura l'accuratezza di una previsione come percentuale, calcolato come: $\frac{1}{N} \sum_{t=1}^{N} \left| \frac{y_t - \hat{y}_t}{y_t} \right|$}}) al variare della dimensione della finestra.
\begin{figure}[htbp]
    \centering
